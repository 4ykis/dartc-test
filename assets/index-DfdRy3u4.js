(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=`https://4ykis.github.io/dartc-test/assets/logo-DQGSFOdr.svg`,t=[{label:`Home`,href:`#`},{label:`Shop`,href:`#`,subItems:[{label:`About`,href:`#`},{label:`FAQ`,href:`#`},{label:`Reviews`,href:`#`},{label:`Photos`,href:`#`},{label:`Gift Boxes`,href:`#`},{label:`Contact`,href:`#`}]},{label:`Collections`,href:`#`,subItems:[{label:`About`,href:`#`},{label:`FAQ`,href:`#`},{label:`Reviews`,href:`#`},{label:`Photos`,href:`#`},{label:`Gift Boxes`,href:`#`},{label:`Contact`,href:`#`}]},{label:`Company`,href:`#`,subItems:[{label:`About`,href:`#`},{label:`FAQ`,href:`#`},{label:`Reviews`,href:`#`},{label:`Photos`,href:`#`},{label:`Gift Boxes`,href:`#`},{label:`Contact`,href:`#`}]},{label:`Support`,href:`#`,subItems:[{label:`About`,href:`#`},{label:`FAQ`,href:`#`},{label:`Reviews`,href:`#`},{label:`Photos`,href:`#`},{label:`Gift Boxes`,href:`#`},{label:`Contact`,href:`#`}]}];function n(e){return`
  ...
  `}function s({image:e,alt:t,title:n}){return`
  ...
  `}function f({isFavorited:e=!1,className:t=``}={}){return`
  ...
  `}function p(){document.addEventListener(`click`,e=>{let t=e.target.closest(`.favorite-button`);if(!t)return;let n=t.dataset.favorited!==`true`,r=t.querySelector(`use`);t.dataset.favorited=n.toString(),t.setAttribute(`aria-label`,n?`Remove from favorites`:`Add to favorites`),r&&(r.href.baseVal=n?`./icons.svg#favorite-check`:`./icons.svg#favorite`),t.classList.toggle(`favorite-button--favorited`,n)})}function m({image:e,alt:t,name:n,settings:r,price:i,oldPrice:a}){return`
    <div class="product">
      <div class="product__image-wrapper">
        <img class="product__image" width="155" height="155" src="${e}" alt="${t}">
        ${f({className:`product__favorite`})}
      </div>
  ...
  `}var h=`https://4ykis.github.io/dartc-test/assets/product_1-BL22EEat.jpg`,g=[{image:h,alt:`Apple iPhone 15 Pro`,name:`Apple iPhone 15 Pro`,settings:`256GB · 8GB RAM · Black`,price:`$999`,oldPrice:`$1,199.00`},{image:`https://4ykis.github.io/dartc-test/assets/product_2-BUWLSNfO.jpg`,alt:`Google Pixel 8 Pro`,name:`Google Pixel 8 Pro`,settings:`128GB · 8GB RAM · Hazel`,price:`$999`,oldPrice:`$1,199`}];function _(){return`
    ...
    <section class="main-product-wrapper">
      <div class="main-product">
        <div class="main-product__image-wrapper">
          <img class="main-product__image" width="326" height="326" src="${h}" alt="Samsung Galaxy S24 Ultra">
          ${f({className:`product__favorite`})}
        </div>
  ...
  `}function y(e){let{id:t,label:n,type:r=`text`,placeholder:i=``,required:a=!1}=e,o=r,s=a?`<span class="form-field__star">*</span>`:``,c=a?`required`:``,l=`<input class="form-field__input" id="${t}" name="${t}" type="${r}" placeholder="${i}" ${c}>`;return o===`textarea`&&(l=`<textarea class="form-field__textarea" id="${t}" name="${t}" placeholder="${i}" ${c}></textarea>`),`
    <div class="form-field">
      <label class="form-field__label" for="${t}">${n} ${s}</label>
      ${l}
      <span class="form-field__notify"></span>
    </div>
  `}function b(e,t){let n=t.trim();if(e===`userName`&&(!n||n.length<2))return`Name must be at least 2 characters`;if(e===`userEmail`&&(!n||!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(n)))return`Please enter a valid email`;if(e===`userMessage`&&(!n||n.length<5))return`Message must be at least 5 characters`}function x(e){let t={},n=e.get(`userName`),r=e.get(`userEmail`),i=e.get(`userMessage`),a=b(`userName`,n);a&&(t.userName=a);let o=b(`userEmail`,r);o&&(t.userEmail=o);let s=b(`userMessage`,i);return s&&(t.userMessage=s),{valid:Object.keys(t).length===0,errors:t}}function S(e,t){return b(e,t)}function C(e,t){let n=document.getElementById(e)?.closest(`.form-field`),r=n?.querySelector(`.form-field__notify`);n&&r&&(n.classList.add(`form-field--error`),r.textContent=t)}function w(){document.querySelectorAll(`.form-field`).forEach(e=>{e.classList.remove(`form-field--error`,`form-field--success`);let t=e.querySelector(`.form-field__notify`);t&&(t.textContent=``)})}function T(e){let t=document.getElementById(e)?.closest(`.form-field`),n=t?.querySelector(`.form-field__notify`);t&&n&&(t.classList.remove(`form-field--error`),n.textContent=``)}function E(){let e=document.querySelector(`.feedback__form`);e&&(e.querySelectorAll(`input, textarea`).forEach(e=>{e.addEventListener(`blur`,()=>{let t=S(e.id,e.value);t?C(e.id,t):T(e.id)})}),e.addEventListener(`submit`,t=>{t.preventDefault(),w();let n=new FormData(e),{valid:r,errors:i}=x(n);if(!r){Object.entries(i).forEach(([e,t])=>{C(e,t)});return}console.log(`Form submitted:`,Object.fromEntries(n));let a=e.closest(`.feedback`)?.querySelector(`.feedback__notification--success`);a?(a.style.display=`block`,e.style.display=`none`,setTimeout(()=>{a.style.display=`none`,e.style.display=`block`,e.reset()},5e3)):e.reset()}))}function D(){return`
    <section class="feedback">
      ...
      <form action="" class="feedback__form">
        ${y({id:`userName`,label:`Name`,type:`text`,placeholder:`Name`,required:!0})}
        ${y({id:`userEmail`,label:`Email`,type:`email`,placeholder:`Email`,required:!0})}
        ${y({id:`userMessage`,label:`Message`,type:`textarea`,placeholder:`Your message`,required:!0})}
  ...
  `}var k=document.getElementById(`app`);k&&(k.innerHTML=O(),i(),E(),p());